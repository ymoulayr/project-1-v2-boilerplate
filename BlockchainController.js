...
class BlockchainController {
    ...
    constructor(app, blockchainObj) {
        ...
        this.validateChain(); // added validateChain end point
        ...
        this.app.post("/submitstar", async (req, res) => {
            if (req.body.address && req.body.message && req.body.signature && req.body.star) {
                ...
                try {
                    ...
                    if (block) {
                        return res.status(200).json(block);
                        // call the validateChain() endpoint after the block has been successfully added  
                        //this.validateChain();
                    } else {
                        return res.status(500).send("An error happened!");
                    }
    ...
    // Added endpoint that will trigger the execution of the blockchain function validateChain() 
    validateChain() {
